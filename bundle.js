...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _stylesheet_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./stylesheet.css */ \"./src/stylesheet.css\");\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom */ \"./src/dom.js\");\n\n\n\nasync function getWeather() {\n  try {\n    const response = await fetch('https://api.openweathermap.org/data/2.5/weather?q=houston&units=imperial&appid=aa5caca7182a564a6034a314252b6ef1', { mode: 'cors' });\n    const weatherData = await response.json();\n    (0,_dom__WEBPACK_IMPORTED_MODULE_1__.renderDom)(weatherData);\n  } catch (error) {\n    (0,_dom__WEBPACK_IMPORTED_MODULE_1__.handleError)();\n  }\n}\n\ngetWeather();\n\nconst btn = document.querySelector('.btn');\nconst searchBar = document.querySelector('.search-bar');\n\nfunction getSearch() {\n  return searchBar.value;\n}\n\nfunction clearSearch() {\n  searchBar.value = '';\n}\n\nasync function searchWeather() {\n  const search = getSearch();\n  try {\n    const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${search}&units=imperial&appid=aa5caca7182a564a6034a314252b6ef1`, { mode: 'cors' });\n    const searchResult = await response.json();\n    (0,_dom__WEBPACK_IMPORTED_MODULE_1__.renderDom)(searchResult);\n    clearSearch();\n  } catch (error) {\n    (0,_dom__WEBPACK_IMPORTED_MODULE_1__.handleError)();\n  }\n}\n\nbtn.addEventListener('click', searchWeather);\n\n\n//# sourceURL=webpack://weather_app/./src/index.js?");
...
eval("module.exports = __webpack_require__.p + \"6ffe269f32e20d4df444.jpeg\";\n\n//# sourceURL=webpack://weather_app/./src/star-night.jpeg?");
